...
public class scoreS3 implements modeleAlgo.FonctionScore {
    ...
    @Override public int scoreSolutionSur100(List<List<EtudiantDTO>> solution) { return scoreSolution(solution); }

    @Override public int scoreGroupe(List<EtudiantDTO> groupe) { return clamp100(100 - penaliteGroupe(groupe)); }
